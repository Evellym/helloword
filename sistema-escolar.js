//EXERCÍCIO 1
class Aluno {
    constructor(matricula, nome, dataNasc, notaFinal, situacao){
...
class Turma {
    constructor(codTurma, dataInicio, dataTermino, curso, listaAlunos) {
...
aluno6 = new Aluno('Sauç', '25/05/2005')
...
const curso1 = new Curso('001', 'Matemática', 'Exatas')
const curso2 = new Curso('002', 'Letras', 'Linguagens')
const curso3 = new Curso('003', 'Biologia', 'Biológicas')
